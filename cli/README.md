...
Today Pacmon ships as a **VS Code extension**: hover a dependency to read its note, right-click to write one. Notes live in your repository in `.pacmon/DEPENDENCIES.md`, travel with git, and render on GitHub. It is fully offline — no account, no network calls, no telemetry.
